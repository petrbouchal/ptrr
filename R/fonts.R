...
#'
#' There is an option `ptrr.loadfonts` which -- if set to `TRUE` -- will
...
import_roboto <- function() {
  ...
  r_font_dir <- system.file("fonts", "roboto", package="ptrr")
...
#' Import fonts needed for theme_ptrr defaults
#'
